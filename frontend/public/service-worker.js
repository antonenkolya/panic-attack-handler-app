...
//     fetch(event.request)
//       .then(response => {
//         // Клонируем результат, так как Response может быть прочитан только один раз
...
//           });
//         // Возвращаем оригинальный результат для использования в браузере
//         return response;
//       })
//       .catch(() => {
//         // Если запрос к серверу не удался, пытаемся найти результат в кеше
...
//   const data = event.data.json(); // Получаем данные уведомления из события push
//   event.waitUntil(
